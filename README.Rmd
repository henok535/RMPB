...
reproducibility metric $\Delta_r$. First a metric $\Theta_{gs}$ under the gold standard
biomarker is estimated. Then $\Theta_{md}$ under the modified biomarker is estimated.
